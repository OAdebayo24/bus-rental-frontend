      ...
      <section className=" flex flex-row ml-16 mt-16 gap-8">
        <form 
          ...
          <Link to="/forgot-password">
            <p className="cursor-pointer flex justify-end">Forgot Password?</p>
          </Link>
        </form>
        <div>
          <h2 className="text-3xl font-bold text-black">Login into your company dashboard</h2>
          <p className="text-gray-600 text-lg max-w-md">
            Organize, your vehicle for hire, and gain reputable audience to support your
            business in hiring your vehicles
          </p>
        </div>
      </section>
    </>
